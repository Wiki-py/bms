...
const productsData = [
  { id: 1, name: 'Product A', price: 29.99, stock: 150, category: 'Electronics', image: 'https://picsum.photos/200/300?random=1' },
  { id: 2, name: 'Product B', price: 49.99, stock: 80, category: 'Clothing', image: 'https://picsum.photos/200/300?random=2' },
  { id: 3, name: 'Product C', price: 19.99, stock: 200, category: 'Books', image: 'https://picsum.photos/200/300?random=3' },
  { id: 4, name: 'Product D', price: 99.99, stock: 50, category: 'Home Appliances', image: 'https://picsum.photos/200/300?random=4' },
...
const Products = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4 text-center md:text-left">Product Management</h1>
            ...
            {filteredProducts.length === 0 ? (
              ...
              filteredProducts.map((product, index) => (
                ...
                >
                  ...
                  <td
                    className="block md:table-cell py-2 px-4 text-sm text-gray-900 before:content-['Stock:'] before:font-bold before:mr-2 md:before:content-none"
                    data-label="Stock"
                  >
                    {product.stock}
                  </td>
